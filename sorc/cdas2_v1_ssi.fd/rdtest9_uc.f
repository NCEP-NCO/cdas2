...
1000  PRINT *,' RDTEST - NUMBER OF PREPDA DTA RECORDS READ=',NMRECS
      ...
      PRINT *,' NSPROF= ',NSPROF
      IF(NTDATA.GT.60000) THEN
       PRINT *,'NTDATA TOO LARGE', NTDATA, 60000
       CALL ABORT
      ENDIF
      IF(NSDATA.GT.120000) THEN
       PRINT *,'NSDATA TOO LARGE', NSDATA, 120000
       CALL ABORT
      ENDIF
      IF(NWDATA.GT.85000) THEN
       PRINT *,'NWDATA TOO LARGE', NWDATA,85000
       CALL ABORT
      ENDIF
      IF(NPDATA.GT.18000) THEN
       PRINT *,'NPDATA TOO LARGE',NPDATA,18000
       CALL ABORT
      ENDIF
      IF(NQDATA.GT.15000) THEN
       PRINT *,'NQDATA TOO LARGE',NQDATA,15000
       CALL ABORT
      ENDIF
      IF(NPWDAT.GT.1) THEN
       PRINT *,'NPWDAT TOO LARGE',NPWDAT,1
       CALL ABORT
      ENDIF
      IF(NSPROF.GT.10000) THEN
       PRINT *,'NSPROF TOO LARGE',NSPROF,10000
       CALL ABORT
      ENDIF
      RETURN
      END
