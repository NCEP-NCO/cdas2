      subroutine gdcrdn(d,nd,x,nx)
c$$$  subprogram documentation block
c                .      .    .                                       .
c subprogram:    gdcrdn      get grid coords for monotonic decreasing
c   prgmmr: parrish          org: w/nmc22    date: 90-10-11
c
c abstract: get grid coords for monotonic decreasing points.
c
