...
C-----------------------------------------------------------------------
      ...
      COMMON /OBS/ NREP,NLEV,SID( 200000 ),INOB( 200000 ),IMAP(360,181)
      COMMON /CKLIST  / NDD,INDD( 300000 )
...
C     DIMENSION IND( 5000 ),NXY( 5000 )
      ...
      IF(NXY(IPK)+1.GT.NMX) THEN
         IF(IPK+1.GT. 5000 ) CALL SABORT('QCPTS - IPK > MAXPAK')
         IPK = IPK+1
         IND(IPK) = I
         NXY(IPK) = 1
      ELSE
...
C     DIMENSION IND( 5000 ),NXY( 5000 )
      ...
      ILEV = INDD(I)
      IF(NXY(IPK)+1.GT.NMX) THEN
         IF(IPK+1.GT. 5000 ) CALL SABORT('SSMIPTS - IPK > MAXPAK')
         IPK = IPK+1
         IND(IPK) = I
         NXY(IPK) = 1
      ELSE
...
C     DIMENSION    OBS(10,255),EVN(10,255),JREP(MAXM,MAXS)
         ...
         IF(JUPD.EQ.1) THEN
            ...
            ELSE
               CALL SABORT('PREPQM - MISSING PRESSURE')
            ENDIF
         ELSEIF(JUPD.EQ.2) THEN
            IF(OBS(1,JLEV).LT.BMISS) THEN
               ...
               EVN(4,JLEV) = 0
            ELSE
               print'(2a8,i8)',sid1,sid2,kkx
               CALL SABORT('PREPQM - MISSING TEMPERATURE')
            ENDIF
         ...
         ELSEIF(JUPD.EQ.3) THEN
            ...
            ENDIF
            IF(UOB.LT.BMISS .AND. VOB.LT.BMISS) THEN
               EVN(1,JLEV) = UOB
               EVN(2,JLEV) = VOB
               EVN(3,JLEV) = QMA
               EVN(4,JLEV) = QCD
            ...
            ELSE
               print'(2a8,i8)',sid1,sid2,kkx
               CALL SABORT('PREPQM - MISSING WIND COMPONENT(S)')
            ENDIF
         ELSE
