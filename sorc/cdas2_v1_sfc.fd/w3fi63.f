...
C
      PRINT *,'FI634'
      write(*,*) "test bitmap flag ", IAND(KPDS(4),64)
      ...
      IF (KPDS(3).EQ.255) THEN
         PRINT *,'NON STANDARD GRID, CENTER = ',KPDS(1)
          ...
          DO 600 I = 1, J
              KBMS(I) = .TRUE.
  600     CONTINUE
	write(*,*) 'kret shoueld be zero=', kret
          RETURN
      END IF
C  -------------------------------------------------------
